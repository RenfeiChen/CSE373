...
public class TestDoubleLinkedList extends BaseTest {
    ...
    @Test(timeout=SECOND)
    public void testBasicRemoveandAdd() {
    	IList<String> list = this.makeInstance();
    	list.add("b");
    	list.add("b");
    	list.add("c");
    	IList<String> list2 = this.makeBasicList();
    	this.assertListMatches(new String[] {"a", "b", "c"}, list2);
    	//list.add("1");
    	//assertEquals(4,list.size());
    	//this.assertListMatches(new String[] {"1","a", "b", "c"}, list);
    	/*list.remove();
    ...
    @Test(timeout=15 * SECOND)
    public void testDeleteinHappyClass() {
        IList<String> list = this.makeBasicList();
    ...
    @Test(timeout=15 * SECOND)
    public void testDeleteinEdgeClass() {
    	IList<Integer> list = this.makeInstance();
    	...
    	list.delete(0);
    	assertListMatches(new Integer[] {2, 4, 6, 8}, list);
    	
    	list.delete(3);
    	assertListMatches(new Integer[] {2, 4, 6}, list);
    	
    	list.delete(0);
    	list.delete(0);
    	
    	assertListMatches(new Integer[] {6}, list);
    ...
    @Test(timeout=15 * SECOND)    
    public void testDeleteinBadInput() {
        IList<String> list = this.makeBasicList();
    ...
    public void testDeleteUpdates() {
        ...
        for (int i = 0; i < cap; i++) {
            list.delete(0);
            assertEquals(cap - i - 1, list.size());
        }
